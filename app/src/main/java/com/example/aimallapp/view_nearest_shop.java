...
public class view_nearest_shop extends AppCompatActivity {
    ListView li;
    String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        li = findViewById(R.id.listview50);

        sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        sh.getString("ipaddress","");
        url = sh.getString("url","") + "nearest_shop";
...
//
                                ...
                                li.setAdapter(new nearest_shop(getApplicationContext(),sh_id,name,lati,logi));
