...
public class view_notifications extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url=sh.getString("url","")+ "and_view_notifications" ;
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                n_id=new String[js.length()];
                                noti=new String[js.length()];
                                date=new String[js.length()];
                                for(int i=0;i<js.length();i++)
                                {
                                    JSONObject u=js.getJSONObject(i);
                                    n_id[i]=u.getString("n_id");
                                    noti[i]=u.getString("noti");
...
//                                }
                                ...
                                li.setAdapter(new custom_view_notifications(getApplicationContext(),n_id,noti,date));
