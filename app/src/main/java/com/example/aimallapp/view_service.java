...
public class view_service extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        li = findViewById(R.id.listview10);

        sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        sh.getString("ipaddress","");
        url=sh.getString("url","")+ "and_view_service" ;
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                longi=new String[js.length()];
                                for(int i=0;i<js.length();i++)
                                {
                                    JSONObject u=js.getJSONObject(i);
                                    s_id[i]=u.getString("s_id");
                                    sname[i]=u.getString("sname");
                                    lati[i]=u.getString("lati");
                                    longi[i]=u.getString("longi");
...
//                                }
                                ...
                                li.setAdapter(new custom_view_service(getApplicationContext(),s_id,sname,lati,longi));
