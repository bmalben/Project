...
public class view_offer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url=sh.getString("url","")+ "and_view_offer" ;
...
//                                }
                                ...
                                li.setAdapter(new custom_view_offer(getApplicationContext(),of_id,price,dis,title));
